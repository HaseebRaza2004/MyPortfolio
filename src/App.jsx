        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, i) => (
              ...
              >
                {/* Gradient Background */}
                <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-blue-600/20 rounded-3xl blur-lg opacity-30 group-hover:opacity-50 transition-opacity" />

                {/* Project Card */}
                <div className="relative bg-white/5 rounded-2xl backdrop-blur-lg border border-white/10 overflow-hidden hover:border-cyan-400/30 transition-all">
                  {/* Project Image */}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex space-x-4">
                      <a
                        href="#"
                        className="px-4 py-2 bg-cyan-500/10 text-cyan-400 rounded-full hover:bg-cyan-500/20 transition-colors"
                      >
                        Live Demo
                      </a>
                      <a
